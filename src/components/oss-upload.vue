...
export default {
    ...
    methods: {
        ...
        getOssToken(){
            var _self = this;
            this.$http.get('/ali/oss/signature').then(function(res){
        ...
        upload(){
            ...
            formData.append('Signature', _self.aliyunOssToken.signature); //签名//如果是base64文件，那么直接把base64字符串转成blob对象进行上传就可以了
